...
--
-- Client: localhost
-- Généré le : Sam 07 Juillet 2012 à 09:59
...
--
-- Base de données: `db_baolong`
--

-- --------------------------------------------------------

--
-- Structure de la table `ci_commentmeta`
--
...
--
-- Structure de la table `ci_comments`
--
...
--
-- Contenu de la table `ci_comments`
--
...
--
-- Structure de la table `ci_links`
--
...
--
-- Contenu de la table `ci_options`
--
...
(107, 0, 'count_visit', '6', 'yes');

-- --------------------------------------------------------

--
-- Structure de la table `ci_postmeta`
--
...
--
-- Contenu de la table `ci_postmeta`
--
...
--
-- Structure de la table `ci_terms`
--
...
--
-- Structure de la table `ci_term_relationships`
--
...
--
-- Contenu de la table `ci_term_relationships`
--
...
--
-- Structure de la table `ci_term_taxonomy`
--
...
--
-- Contenu de la table `ci_term_taxonomy`
--
...
--
-- Structure de la table `ci_usermeta`
--
...
--
-- Contenu de la table `ci_usermeta`
--
...
(1, 'admin', 'admin@123', 'admin', 'vinhnt@tasvis.com.vn', '', '2012-06-12 15:26:34', '', 0, 'Nguyễn Tất Vinh'),
