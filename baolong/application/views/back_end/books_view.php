        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">            	
                <ul class="maintabmenu multipletabmenu">
                    ...
                    <li><a href="<?php echo base_url();?>admin/books/add">Thêm mới sách</a></li>
                    <li class="current"><a href="<?php echo base_url();?>admin/bookcats">Danh mục sách</a></li>
                </ul>
                <div class="content">                	
                	<div class="edit-left">
                	...
                	{
                	?>
                		<?php echo form_open('admin/bookcats/save_categories',array('id'=>'formID','class'=>'stdform'));?>
                    ...
                    ?>
                    <?php echo form_open('admin/bookcats/edit',array('id'=>'formID','class'=>'stdform'));?>   
                    ...
                    <div class="list-right">
                    	<div class="contenttitle radiusbottom0">
                            <h2 class="table"><span>Danh mục sách</span></h2>
                        </div><!--contenttitle-->
                            ...
                            <tbody>
                                <?php foreach($lstCategories as $Category){?>                            	
                                    <tr>
                                        ...
                                        <td class="center"><a class="edit" title="Sửa" href="<?php echo base_url();?>admin/bookcats/edit/<?php echo $Category->term_id;?>">Sửa</a> &nbsp; <a class="delete" id="<?php echo $Category->term_id;?>" name="delete" title="Xóa danh mục" href="<?php echo base_url();?>admin/bookcats/delete" >Xóa</a></td>
