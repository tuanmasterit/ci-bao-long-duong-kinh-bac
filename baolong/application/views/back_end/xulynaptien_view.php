        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">            	
                <ul class="maintabmenu multipletabmenu">
                	<li class="current"><a href="#">Xử lý nạp tiền</a></li>
                </ul>                
                <div class="content">
                	<h1 id="ajaxtitle"></h1>                       	                            
                    <div class="contenttitle radiusbottom0">
                        <h2 class="table"><span>Danh sách yêu cầu nạp tiền</span></h2>
                    </div><!--contenttitle-->
                    <div class="tableoptions">   
                    	<form method="post" action="<?php echo base_url();?>admin/xulynaptien">
                            Từ ngày:&nbsp;
