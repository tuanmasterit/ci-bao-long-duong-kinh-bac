	...
	<div id="title">
		<h4>
			<?php
        		...
        		{
        	?>
            <span><a href="<?php echo base_url().'welcome/cat/'.$cat->term_id;?>"><?php echo $cat->name;?></a></span>
            <?php 
        		}
        		else
        		{ 
            ?>
            <span><a href="<?php echo base_url().'welcome/cat/'.$parentCat['term_id'];?>"><?php echo $parentCat['name'];?></a> - <a href="<?php echo base_url().'welcome/cat/'.$cat->term_id;?>"><?php echo $cat->name;?></a></span>
            <?php 
        		}
        	?>
		</h4>
