        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">            	
                <ul class="maintabmenu multipletabmenu">
                	<li  class="current"><a href="<?php echo base_url();?>admin/books/index">Tất cả sách</a></li>
                ...
                <div class="content">
                    ...
                    <div class="contenttitle radiusbottom0">
                        <h2 class="table"><span>Danh sách sách</span></h2>
                    </div><!--contenttitle-->
                    <div class="tableoptions">
                    	<form name="frmfilter" method="post" action="<?php echo base_url();?>admin/books" >
                        ...
                        <tbody>
                            <?php foreach($lstPosts as $Post){?>                            	
                            	<tr>
                                    ...
                                    <td class="center">
                                    	<a class="edit" href="<?php echo base_url();?>admin/books/edit/<?php echo $Post->id;?>">Sửa</a> &nbsp; 
                                        <a class="delete" name="delete_post" id="<?php echo $Post->id;?>" href="<?php echo base_url();?>admin/books/delete">Xóa</a></td>
                                </tr>
                            <?php }?>
                        </tbody>
                    </table>
