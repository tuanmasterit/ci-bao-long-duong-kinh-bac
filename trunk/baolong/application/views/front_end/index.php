...
<head>
    ...
    <title>Công ty cổ phần Bảo Long Đường Kinh Bắc</title>
            ...
            <div id="menu-top">
                <div id="menu-top-center">
                    <ul id="nav">
                        ...
                        <li><a href="#"
                            class="parent"><span>Giới thiệu</span></a><ul class="gioi_thieu_hover">
                                <li><a href="#">Tập đoàn</a></li><li><a href="#">Cơ cấu tổ chức</a></li><li><a href="#">
                                    Thành tích</a></li><li><a href="#">Tổng giám đốc</a></li></ul>
                        </li>
                        <li><a href="#" class="parent"><span>Tin tức</span></a>
                        	<ul class="tin_tuc_hover">
                                ...
                                <li><a href="#">Thương vụ Bảo Long Bảo Sơn</a></li></ul>
                        </li>
                        <li><a href="#" class="parent"><span>Sản phẩm</span></a><ul class="cam_nang_hover">
                            <li><a href="#">Đông Dược</a></li><li><a href="#">Mỹ phẩm</a></li><li><a href="#">Thực
                                phẩm chức năng</a></li><li><a href="#">Rượu</a></li><li><a href="#">Trà thảo dược</a></li></ul>
                        </li>
                        <li><a href="#" class="parent"><span>Y tế sức khỏe</span></a><ul class="y_te_suc_khoe_hover">
                            <li><a href="#">Chuyên đề đông y</a></li><li><a href="#">Bệnh thường gặp</a></li><li>
                                <a href="#">Ăn kiêng theo bệnh</a></li><li><a href="#">Tự xoa bóp bấm huyệt</a></li><li>
                                    <a href="#">Làm đẹp</a></li></ul>
                        </li>
                        <li><a href="#" class="parent"><span>Tư vấn khám bệnh</span></a><ul class="tin_tuc_chuyen_nganh_hover">
                            <li><a href="#">Phác đồ điều trị</a></li><li><a href="#">Tự chữa bệnh tại nhà</a></li><li>
                                <a href="#">Biện chứng luận trị</a></li><li><a href="#">Tư vấn và giải đáp</a></li></ul>
                        </li>                        
                        <li><a href="#" class="parent"><span>Sách</span></a><ul class="">
                            <li><a href="#">Văn học-thơ ca</a></li><li><a href="#">Y học</a></li><li><a href="#">
                                Khí công-Y võ dưỡng sinh</a></li></ul>
                        </li>
                    ...
                    <div id="hot_news">
                        <div class="content">
                            ...
                            <ul>
                                <li>
                                    <div class="img">
                                        <img src="<?php base_url();?>application/content/images/nguoihanoi.jpg"></div>
                                    <p>
                                        <a title="Thương vụ tranh chấp Bảo Long - Bảo Sơn: Những chiêu thức tàn bạo đã bị phơi bày."
                                            class="tooltip" href="">
                                            Thương vụ tranh chấp Bảo Long - Bảo Sơn: Những chiêu thức tàn bạo đã bị phơi bày.</a></p>
                                </li>
                                <li>
                                    <div class="img">
                                        <img src="<?php base_url();?>application/content/images/voykisu.jpg"></div>
                                    <p>
                                        <a title="Võ y ký sự" class="tooltip" href="/vi/tin-tuc/thuong-vu-bao-long-bao-son/a-10197/vo-y-ky-su.aspx">
                                            Võ y ký sự</a></p>
                                </li>
                                <li>
                                    <div class="img">
                                        <img src="<?php base_url();?>application/content/images/nguoihanoi.jpg"></div>
                                    <p>
                                        <a title="Ai có tài sản bị hủy hoại?" class="tooltip" href="">
                                            Ai có tài sản bị hủy hoại?</a></p>
                                </li>
                                <li>
                                    <div class="img">
                                        <img src="<?php base_url();?>application/content/images/tien-phong.jpg"></div>
                                    <p>
                                        <a title="Cuộc chiến Bảo Long - Bảo Sơn trước dấu chấm hết." class="tooltip" href="/vi/tin-tuc/thuong-vu-bao-long-bao-son/a-9946/cuoc-chien-bao-long---bao-son-truoc-dau-cham-het-.aspx">
                                            Cuộc chiến Bảo Long - Bảo Sơn trước dấu chấm hết.</a></p>
                                </li>
                                <li>
                                    <div class="img">
                                        <img src="<?php base_url();?>application/content/images/nguoihanoi.jpg"></div>
                                    <p>
                                        <a title="" class="tooltip" href="">
                                            Lịch xem mạch, kê đơn, châm cứu và quy trình khám bệnh, điều trị của Thầy thuốc
                                            Ưu tú, Lương y, Ts Nguyễn Hữu Khai.</a></p>
                                </li>
                            </ul>
                            <div class="clear">
                            </div>
